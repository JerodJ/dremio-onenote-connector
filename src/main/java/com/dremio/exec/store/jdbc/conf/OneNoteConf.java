...
@SourceType(value = "OneNoteARP", label = "OneNote",uiConfig = "onenote-layout.json")
public class OneNoteConf extends AbstractArpConf<OneNoteConf> {
  private static final String ARP_FILENAME = "arp/implementation/onenote-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.onenote.OneNoteDriver";
